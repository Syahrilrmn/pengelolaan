<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-table"></i> Laporan Data Riwayat Kenaikan Pangkat
        </h3>
    </div>
    <?php
    ...
    if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
        ...
        $url_cetak = "admin/riwayatkp/print_riwayatkp.php";
        $label = "( Semua Data Riwayat Kenaikan Pangkat )";
    } else { // Jika terisi
        // Buat query untuk menampilkan data transaksi sesuai periode tanggal
        $query = "SELECT * FROM tb_riwayatkp WHERE (tgl BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
        $url_cetak = "admin/riwayatkp/print_riwayatkp.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
    ...
    <div style="padding: 15px;">
        ...
        <div>
            <h6 style="margin-left: auto;"><b>Laporan Data Riwayat Kenaikan Pangkat</b>
                <?php echo $label ?>
            </h6>
