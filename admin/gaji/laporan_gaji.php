<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="index.php?page=data-gaji">Data Gaji</a></li>
    <li class="breadcrumb-item active">Laporan Data Gaji</li>
</ol>
<div class="card card-info">
    ...
    if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
        ...
        $query = "SELECT * FROM tb_data_gaji";
    ...
    <div style="padding: 15px;">
        ...
        <div>
            ...
            <a href="admin/gaji/gaji_cetak.php" class="btn btn-warning" target="_blank">
					<i class="fa bi bi-printer-fill"></i> Cetak Laporan Gaji</a>
            </a>
        </div>
        <hr />
        <div class="card-body">
