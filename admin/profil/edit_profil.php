	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="nama_pemerintahan" name="nama_pemerintahan" value="<?php echo $data_cek['nama_pemerintahan']; ?>"
					/>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="nama_dinas" name="nama_dinas" value="<?php echo $data_cek['nama_dinas']; ?>"
					/>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
				   <img src="foto/<?php echo $data_cek['logo']; ?>" 
					 alt="" width="80">
				</div>
			</div>
			<div class="form-group row">
...
$pindah = move_uploaded_file($sumber, $target.$nama_file);
    ...
    nama_pemerintahan='".$_POST['nama_pemerintahan']."',
