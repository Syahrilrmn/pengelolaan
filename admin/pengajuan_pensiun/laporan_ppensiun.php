<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Laporan Pengajuan Pensiun</li>
</ol>
<div class="card card-info">
    ...
    <div style="padding: 15px;">
        ...
        <div>
            <h6 style="margin-left: auto;"><b>Laporan Pengajuan Pensiun</b>
                <?php echo $label ?>
            </h6>
            <a href="admin/pengajuan_pensiun/cetak_ppensiun.php" class="btn btn-warning" target="_blank">
					<i class="fa bi bi-printer-fill"></i> Cetak Laporan Pengajuan Pensiun</button>
            </a>
        </div>
        <hr />
        <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					if (isset($_POST['nip'])) {
						$nip = $_POST['nip'];
						$sql = mysqli_query($koneksi, "select * from tb_ppensiun where nip='$nip'");
					} else {
