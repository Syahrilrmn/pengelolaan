...
$sql = "SELECT * FROM tb_ppensiun WHERE ket='DITERIMA' order by nip asc";                     
...
<body>
    ...
    <h3>
        <center>
            LAPORAN DATA PENGAJUAN PENSIUN DITERIMA<br>
        </center>
    </h3>
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>          
                                ...
                                <td align="center"><?php echo $data['usia']; ?> Tahun</td>
                                <td align="center"><?php echo $data['jk']; ?></td>
                                <td align="center"><?php echo  tgl_indo($data['tmt_kinerja']); ?></td>
                                <td align="center"><?php echo rupiah($data['gapok']); ?></td>
