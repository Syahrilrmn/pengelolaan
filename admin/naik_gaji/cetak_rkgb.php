...
$sql = "SELECT * FROM tb_naik_gaji order by nip asc";                     
...
<body>
    ...
    <h3>
        <center>
            LAPORAN DATA REKAPITULASI KGB<br>
        </center>
    </h3>
    <div class="row">
        <div class="col-sm-12">
                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr style="background-color: darkgrey" height="30px">
                            ...
                            <th style="text-align: center; font-size: 18px;">Unit Organisasi</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>          
                                ...
                                <td align="center"><?php echo $data['jeniskelamin']; ?> Tahun</td>
