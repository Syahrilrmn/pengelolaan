<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-table"></i> Laporan Pegawai Naik Gaji
        </h3>
    </div>
    <?php
    ...
    if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
        ...
        $url_cetak = "admin/naik_gaji/naik_gaji_cetak.php";
        $label = "( Semua Data Pegawai Naik Gaji )";
    } else { // Jika terisi
        // Buat query untuk menampilkan data transaksi sesuai periode tanggal
        $query = "SELECT * FROM tb_naik_gaji WHERE (tgl BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
        $url_cetak = "admin/naik_gaji/naik_gaji_cetak.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
    ...
    <div style="padding: 15px;">
        ...
        <div>
            <h6 style="margin-left: auto;"><b>Laporan Pegawai Naik Gaji</b>
                <?php echo $label ?>
            </h6>
