...
$sql = "SELECT * FROM tb_kgb order by nip asc";                     
                ...
                <table border="1" cellspacing="0" width="100%">
                    <thead>
                        <tr style="background-color: darkgrey" height="30px">
                            ...
                            <th style="text-align: center; font-size: 18px;">No. Surat</th>
                            <th style="text-align: center; font-size: 18px;">Tgl. Surat</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>          
                                ...
                                <td align="center"><?php echo  tgl_indo($data['tanggal_surat']); ?></td>
                                <td align="center"><?php echo $data['pangkat']; ?></td>
                                <td align="center"><?php echo rupiah($data['gajilama']); ?></td>
                                <td align="center"><?php echo rupiah($data['gajibaru']); ?></td>
                        <?php } ?>
                    </tbody>
