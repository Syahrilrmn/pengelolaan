				...
				<?php
					...
					?>
						...
						<tr>
                            ...
                            <td>
								<a href="?page=add-pengajuankgb-01&kode=<?php echo $data['nip']; ?>" title="Proses"
							        class="btn btn-success btn-sm">
								    <i class="fa fa-plus"></i>
							    </a>
								<a href="?page=detail-pengajuankgb-01&kode=<?php echo $data['nip']; ?>" title="Proses"
							        class="btn btn-primary btn-sm">
								    <i class="fa fa-eye"></i> Lihat
							    </a>
							</td>
							<td>
								<a href="?page=edit-pengajuankgb-01&kode=<?php echo $data['nip']; ?>">
                                <?php echo $data['ket']; ?>
                                </a>
							</td>
