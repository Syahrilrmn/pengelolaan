<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Laporan Pengajuan KGB Diterima</li>
</ol>
<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-table"></i> Laporan Pengajuan KGB yang Diterima
        </h3>
    </div>
    ...
    if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
        ...
        $label = "( Semua Pengajuan KGB yang Diterima)";
    } else { // Jika terisi
    ...
    <div style="padding: 15px;">
        ...
        <div>
            <h6 style="margin-left: auto;"><b>Laporan Pengajuan KGB Diterima</b>
                <?php echo $label ?>
            </h6>
            <a href="admin/pengajuan_kgb/cetak_diterima.php" class="btn btn-warning" target="_blank">
					<i class="fa bi bi-printer-fill"></i> Cetak Laporan Pengajuan KGB Diterima</button>
            </a>
        </div>
        <hr />
        <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
                    $no = 1;
					$sql = $koneksi->query("select * from tb_pkgb WHERE ket='DITERIMA'");
