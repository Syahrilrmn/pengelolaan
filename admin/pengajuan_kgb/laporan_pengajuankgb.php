<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Laporan Pengajuan KGB</li>
</ol>
<div class="card card-info">
    ...
    <div style="padding: 15px;">
        ...
        <div>
            <h6 style="margin-left: auto;"><b>Laporan Pengajuan KGB</b>
                <?php echo $label ?>
            </h6>
            <a href="admin/pengajuan_kgb/cetak_pengajuankgb.php" class="btn btn-warning" target="_blank">
					<i class="fa bi bi-printer-fill"></i> Cetak Laporan Pengajuan KGB</button>
            </a>
        </div>
        <hr />
        <div class="card-body">
