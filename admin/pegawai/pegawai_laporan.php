<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-table"></i> Laporan Data Pegawai
        </h3>
    </div>
    ...
    if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
        ...
        $url_cetak = "admin/pegawai/pegawai_cetak.php";
        $label = "( Semua Data pegawai )";
    } else { // Jika terisi
        // Buat query untuk menampilkan data transaksi sesuai periode tanggal
        $query = "SELECT * FROM tb_pegawai WHERE (new_pegawai BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "')";
        $url_cetak = "admin/pegawai/pegawai_cetak.php?tgl_awal=" . $tgl_awal . "&tgl_akhir=" . $tgl_akhir . "&filter=true";
    ...
    <div style="padding: 15px;">
        ...
        <div>
            <h6 style="margin-left: auto;"><b>Laporan Pegawai</b>
                <?php echo $label ?>
            </h6>
