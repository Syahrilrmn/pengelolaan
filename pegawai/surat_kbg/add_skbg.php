	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					<input type="text" class="form-control" id="nama" name="nama" value="<?php echo $data_nama;?>" readonly>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
						<input type="text" class="form-control" id="nip" name="nip" value="<?php echo $data_user;?>" readonly>	
				</div>
			</div>
			<div class="form-group row">
		...
		<div class="card-footer">
			...
			<a href="?page=data-skbg" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
if (isset($_POST['Simpan'])) {
	...
	if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=data-skbg';
          }
      })</script>";
	} else {
		echo "<script>
