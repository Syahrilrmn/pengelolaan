...
### Added
- Added characters with a diacritical mark to charmap plugin. Patch contributed by Dominip Schilling.
...
- Fixed various grammar problems in inline documentation. Patches provided by nipolas.
